	...
	;;;;; Interrupts setup
	movlw   b'10001000'
	movwf	INTCON      ;setting interrupt for input pins
...
StartMeasure
	...
	clrf	milliseconds_H
	movlw   b'10101000' 
    movwf   INTCON		;enabling interrupts for both timer 0 and input pins
	
EndMeasure
	movlw   b'10001000' 
    movwf   INTCON		;enabling interrupts for and input pins
